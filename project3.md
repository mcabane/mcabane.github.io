...
![screenshot](images/Charity-Run-Home-Page.png)   
Fig 1. Home Page.  

<br/>

![screenshot](images/Charity-Run-About-Page.png)
Fig 2. About Page.    

<br/>

![screenshot](images/Charity-Run-Sign-Up-Page.png)  
Fig 3. Sign-Up Page where user inputs: name, email, age, emergency phone, password, and team name (optional).  

<br/>

![screenshot](images/Charity-Run-Sign-Up-Validation.png)  
Fig 4. Example of validation check when signing up.   

<br/>

![screenshot](images/Charity-Run-Login-Page.png)  
Fig 5. Login Page.  
